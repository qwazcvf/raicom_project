...
class SafeYTask(Node):
    def __init__(self):
        super().__init__("task1_safe_y_v2")
...
def main():
    ...
    parser.add_argument("--burst-time", type=float, default=0.8)
    parser.add_argument("--rest-time", type=float, default=1.0)
